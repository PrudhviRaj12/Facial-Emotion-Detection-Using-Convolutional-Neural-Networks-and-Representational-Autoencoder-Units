...
"""
The program is for the two layer dense
autoencoder network.

The strucutre of this autoencoder is 
4096 - 2800 - 300/500 - 2800 - 4096. 
...
reps = open('two_layer_ae_' +str(hidden_units) +'_hn_rep/' + emotion + '_' + str(hidden_units) + '_reptoo.txt', 'wb')
